...
#
# guess_the_atom - analyse the measured anomalous differences between I+/-
# to get a decent guess as to what the heavy atom is, given the number of
# sites.
        ...
        if 'I(+)' in columns and 'I(-)' in columns:
            ...
            for j, atom in enumerate(atoms):
                for energy_offset in (-100.0, 0.0, 100.0):
                    wavelength_test = wavelength_energy(energy + energy_offset)
                    fdp = tables[j].at_angstrom(wavelength_test).fdp()
